...
?>
<main>
<h2 class="card__header text-center card__header-border weight-500">Uredi firmu</h2>
<div class="wrapper">
...
<form action="" method="POST">
    <div class="card-body">
        <div class="mb-xm">
            ...
            <input type="text" name="<?php echo $firm['id']; ?>-ime" id="name"  class="form__input" value="<?php echo $firm['ime']; ?>">
            <span class="registration-form__error"></span>
        </div>
        <div class="mb-xm">
            <label for="logo" class="file-label mb-xs">Dodaj logotip <i class="fas fa-upload hide-icon"></i></label>
            <i class="fas fa-times <?php echo $firm['logo'] ? 'd-block' : 'd-none'; ?> remove-image pointer text-right mb-xs"></i>
            <input type="file" name="logo" id="logo" class="form__input-file">
            <img src="<?php base(); echo 'images/' . $firm['logo']; ?>" alt="" class="firm-logo d-block m-auto">
            <span class="registration-form__error"></span>
        </div>
        <div class="mb-xm">
            <label for="jib">Jedinstveni identifikacioni broj</label>
            <input type="text" name="jib" id="jib"  class="form__input" value="<?php echo $firm['jib']; ?>">
            <span class="registration-form__error"></span>
        </div>
        <div class="mb-xm">
            ...
            <div class="d-flex">
                <div class="mb-xs w-100">
                    <input type="radio" <?php echo $firm['pdv'] == '1' ? 'checked' : ''; ?> name="pdv" id="pdv-da" value="1">
                    <label for="pdv-da">Da</label>
                </div>
                <div class="w-100">
                    <input type="radio" <?php echo $firm['pdv'] == '0' ? 'checked' : ''; ?> name="pdv" id="pdv-ne" value="0">
        ...
        <div class="mb-xm d-none">
            ...
            <input type="text" name="pib" id="pib" disabled class="form__input pib"  value="<?php echo $firm['pib']; ?>">
            <span class="registration-form__error"></span>
        </div>
        <?php } else { ?>
            <div class="mb-xm">
            <label for="pib">Poreski identifikacioni broj</label>
            <input type="text" name="pib" id="pib" class="form__input pib"  value="<?php echo $firm['pib']; ?>">
            <span class="registration-form__error"></span>
        </div>
        <?php } ?>
        <div class="mb-xm">
            <label for="vlasnik">Ime vlasnika</label>
            <input type="text" name="vlasnik" id="vlasnik" class="form__input"  value="<?php echo $firm['vlasnik']; ?>">
            <span class="registration-form__error"></span>
        </div>
        <div class="mb-xm">
            <label for="adresa">Adresa firme</label>
            <input type="text" name="adresa" id="adresa" class="form__input"  value="<?php echo $firm['adresa']; ?>">
            <span class="registration-form__error"></span>
        </div>
        <div class="mb-xm">
        ...
        <div class="mb-xm">
            ...
            <input type="text" name="telefon" id="broj" class="form__input"  value="<?php echo $firm['telefon']; ?>">
            <span class="registration-form__error"></span>
        </div>
        <div class="mb-xm">
            <label for="email">Email adresa</label>
            <input type="text" name="email" id="email" class="form__input"  value="<?php echo $firm['email']; ?>">
            <span class="registration-form__error"></span>
        </div>
        <div class="mb-xm">
