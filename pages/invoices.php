    ...
    ?>
        <div class="w-25-gap-m l-w-50-gap-m s-w-100 card relative">
            ...
            <div class="card-body">
                ...
                <span class="d-block">Kupac:</span> <span class="d-block mb-xs"> <?php echo $client['ime'];?></span>
                <span class="d-block">JIB kupca: </span><span class="d-block mb-xs"> <?php echo $client['jib'];?></span>
                <span class="d-block">Adresa kupca: </span><span class="d-block mb-xs"> <?php echo $client['adresa'];?></span>
                ...
                <a href="render_pdf/<?php echo $invoice['id'] ?>" class="btn btn-info mb-xs">Pregled</a>
                <a href="update_invoice/<?php echo $invoice['id'] ?>" class="btn btn-info">Uredi</a>
            </div>
        </div>
    <?php } ?>
        </div>
