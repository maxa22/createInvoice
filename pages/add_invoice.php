        ...
        <div id="articles">
            ...
            <div class="d-flex articlesNumber m-w-100 m-flex-column m-card m-mb-m" id="articlesBody">
                <div class="w-30 border relative m-d-flex m-w-100">
                    <span class="w-100 p-x btn-primary weight-600 d-none m-w-100 m-d-block">Artikal</span>
                ...
                <div class="w-10 border m-d-flex m-w-100">
                    <span class="w-100 p-x btn-primary weight-600 d-none m-w-100 m-d-block">Popust</span>
                ...
                <div class="w-10 border m-d-flex m-w-100">
                    <span class="w-100 p-x btn-primary weight-600 d-none m-w-100 m-d-block">PDV</span>
                    <input type="text" name="1-pdv" class="w-100 p-xs form__input border-none h-100 PDV" >
                    <span class="registration-form__error"></span>
                </div>
                <div class="w-10 border m-d-flex m-w-100">
                    <span class="w-100 p-x btn-primary weight-600 d-none m-w-100 m-d-block">Ukupno</span>
